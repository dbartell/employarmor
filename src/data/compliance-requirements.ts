    ...
    requirements: [
      {
        ...
        description: 'Publish AI system purpose, data used, and deployment context',
        type: 'document',
        docType: 'disclosure-candidate',
        href: '/disclosures',
      ...
      {
        id: 'tx-intent-documentation',
        title: 'Intent Documentation',
        description: 'Document non-discriminatory intent in AI procurement and deployment',
        type: 'action',
        href: '/documents',
      ...
      },
      {
        ...
        description: 'Develop risk management policy as safe harbor defense',
        type: 'document',
        docType: 'risk-management-policy',
        href: '/documents?generate=risk-management-policy',
        estimatedTime: '~20 min',
        estimatedMinutes: 20,
        phase: 'setup_once',
        priority: 2,
