        ...
        <div className="mb-8">
            ...
            {([1, 2, 3, 4, 5] as WizardStep[]).map((s) => {
              ...
              return (
                <div key={s} className="flex items-center">
                  <button
                    onClick={() => goToStep(s)}
                    className={`relative w-10 h-10 rounded-full flex items-center justify-center font-medium transition-all duration-200 ${
                      isActive 
                  ...
                  {s < 5 && (
                    <div className={`w-12 sm:w-16 h-1 mx-1 sm:mx-2 rounded transition-colors duration-200 ${
          ...
          <div className="flex justify-between text-xs text-gray-600">
            {([1, 2, 3, 4, 5] as WizardStep[]).map((s) => {
              const completion = getStepCompletion(s, formData)
              return (
                <div key={s} className="text-center w-10">
                  <div className={step === s ? 'font-medium text-blue-600' : ''}>
