        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
            <p className="text-blue-800">
              <strong>Tip:</strong> The notice can be provided via the job posting, email, or a dedicated web page. EmployArmor can generate compliant notice language for your specific AEDT.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <div className="border-b pb-6">
              ...
              <p className="text-gray-600">On your careers page or any publicly accessible website page. EmployArmor can generate a compliant disclosure page template for you.</p>
            </div>
          </div>
        </div>
      </section>
